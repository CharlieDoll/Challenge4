...
const quiz_box = document.querySelector(".questionnaire_box");
const result_box = document.querySelector(".result_box");
const option_list = document.querySelector(".option_list");
const time_line = document.querySelector("header .time_line");
const timeText = document.querySelector(".timer .time_left_txt");
const timeCount = document.querySelector(".timer .timer_sec");
const applicantName = document.getElementById("App_name");
var scoreSub = document.getElementById("score_submission");
...
function showResult() {
  ...
  var scoreSub = result_box.querySelector("score_submission");
  if (scoreSub) {
  ...
  function formSubmission() {
    applicantName.innerText;
    if (confirm("Finish")) {
      alert(`${applicantName} You Have Completed the Questionnaire!`);
    } else {
      return false;
    }
  }
  ...
  let questions = [
    ...
    //   question: 8,
    //   question:
    //     "String Values can be enclosed in _______ when being assigned to ?",
